...
class AccountsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('primary_owner')
            ->requirePresence('primary_owner', 'create')
            ->notEmpty('primary_owner')
            ->add('primary_owner', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['primary_owner']));
